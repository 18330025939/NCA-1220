...
/*SPI*/
#ifdef  CONFIG_PHYTIUM_SPI
#define PHYTIUM_PIN_PAD_BASE	0x28180000
#define PHYTIUM_GPIO0_BASE		0x28004000
#define PHYTIUM_GPIO1_BASE		0x28005000
#define GPIO_SWPORTA_DR			0x0
#define GPIO_SWPORTA_DDR		0x4
#define GPIO1_PORTA_5_HIGH		0x20
#define GPIO1_PORTA_5_LOW		0x00
#endif
