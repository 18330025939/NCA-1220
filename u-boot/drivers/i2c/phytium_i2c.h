...
#ifndef __PHYTIUM_I2C_H_
#define __PHYTIUM_I2C_H_
...
#define FT_IC_COMP_PARAM_1_SPEED_MODE_MASK      (BIT(2) | BIT(3))

/**
 * struct ft_scl_sda_cfg - I2C timing configuration
 *
...
/**
 * struct ft_i2c_speed_config - timings to use for a particular speed
 *
...
/**
 * struct ft_i2c - private information for the bus
 *
...
struct ft_i2c {
	...
	struct ft_scl_sda_cfg *scl_sda_cfg;
...
extern const struct dm_i2c_ops ft_i2c_ops;
...
/**
 * ft_i2c_gen_speed_config() - Calculate config info from requested speed
 *
